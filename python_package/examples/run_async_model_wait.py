...
def wait_for_requests(ie):
    """Separate thread function to wait for requests from the result_queue."""
    global end_time
    while not result_queue.empty():
        try:
            ...
            print("Waiting for requests timed out.")
            break
    end_time = time.time()
...
if __name__ == "__main__":
    ...
    # Start a separate thread to wait for all the requests to complete
