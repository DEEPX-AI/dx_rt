...
#define READ_${module.name}_${reg.name}(base) dxrt::readl((void*)base, REG_${module.name}_${reg.name})
#define WRITE_${module.name}_${reg.name}(base, val) dxrt::writel((void*)base, REG_${module.name}_${reg.name}, val)
...
#define READ_MASK_${module.name}_${reg.name}_${regbits.field}(base) \\

    dxrt::readl_mask((void*)base, REG_${module.name}_${reg.name}, ${module.name}_${reg.name}_${regbits.field}_MASK)
#define READ_${module.name}_${reg.name}_${regbits.field}(base) \\

    dxrt::readb((void*)base, REG_${module.name}_${reg.name}, ${module.name}_${reg.name}_${regbits.field}_MASK, ${module.name}_${reg.name}_${regbits.field}_OFFSET)
#define WRITE_${module.name}_${reg.name}_${regbits.field}(base, bits) \\

    dxrt::writeb((void*)base, REG_${module.name}_${reg.name}, bits, ${module.name}_${reg.name}_${regbits.field}_MASK, ${module.name}_${reg.name}_${regbits.field}_OFFSET)
...
int Verify_${module.name[0]+module.name[1:].lower()}_Registers(dx${module.name}_t* base);
