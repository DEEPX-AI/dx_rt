...
int main(int argc, char* argv[])
{
    ...
    {
        std::cout << "[Usage] run_async_model_bound [dxnn-file-path] [loop-count]" << std::endl;
        return -1;
    }
    ...
    try 
    {
        ...
        std::cout << "Created " << THREAD_COUNT << " threads with bound options:" << std::endl;
        std::cout << "  Thread 0,1: NPU_0 (Bound " << dxrt::InferenceOption::BOUND_OPTION::NPU_0 << ")" << std::endl;
        std::cout << "  Thread 2,3: NPU_12 (Bound " << dxrt::InferenceOption::BOUND_OPTION::NPU_12 << ")" << std::endl;
        std::cout << "  Total different bound types: 2 (within 3-type limit)" << std::endl;
