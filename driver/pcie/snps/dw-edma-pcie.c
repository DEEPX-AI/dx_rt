...
#else
	#define DMA_DESC_START_ADDR	(0xA00000000)
...
/* DXNN V1 - m1 */
static const struct dw_edma_pcie_data dx_pcie_data_v1 = {
	.version			= 1,
	.desc_addr			= DMA_DESC_START_ADDR,
	/* eDMA registers location */
	.rg.bar				= BAR_2,
...
static const struct dw_edma_pcie_data dx_pcie_data_v2 = {
	...
	.users = {
		/* MESSAGE */
		// DW_NPU_BLOCK(BAR_3, 0x00000000, 0x00100000, 0x00300000)
		DW_NPU_BLOCK(BAR_3, 0x00000000, 0x00100000, 0xD8100000)
		DW_NPU_BLOCK(BAR_4, 0x00000000, 0x00100000, 0xCD800000)
	},
};
...
static const struct pci_device_id dx_dma_pcie_id_table[] = {
	...
	// { PCI_DEVICE(0x16c3, 0x1004), .driver_data = (kernel_ulong_t)(&dx_pcie_data_v1) },
