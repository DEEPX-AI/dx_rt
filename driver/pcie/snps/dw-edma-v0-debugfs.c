...
DEFINE_SHOW_ATTRIBUTE(dx_pcie_bandwidth);

static ssize_t dx_pcie_clear_bandwidth_write(struct file *file,
...
static const struct file_operations dx_pcie_clear_bandwidth_fops = {
	.write = dx_pcie_clear_bandwidth_write,
};
...
void dw_edma_v0_debugfs_on(struct dw_edma_chip *chip)
{
	...
	/* bandwidth */
	debugfs_create_file("bandwidth", 0444, dw->debugfs, NULL, &dx_pcie_bandwidth_fops);
	debugfs_create_file("clear_bandwidth", 0444, dw->debugfs, NULL, &dx_pcie_clear_bandwidth_fops);
	dw_edma_message_debugfs_on(chip);
}
