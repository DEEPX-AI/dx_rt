...
#define MSGRAM_MSG_OFFSET 0x0
#define MSGRAM_REQUEST_OFFSET 0x1000
#define MSGRAM_RESPONSE0_OFFSET 0x2000
#define MSGRAM_RESPONSE1_OFFSET 0x3000
#define MSGRAM_LOG_OFFSET 0x4000
#define MSGRAM_DEBUG_OFFSET 0x8000
...
struct dw_edma {
	...
	// dxrt
	void __iomem                *response[2];
	dx_pcie_response_list_t     responses[2];
	spinlock_t                  responses_lock[2];
};
