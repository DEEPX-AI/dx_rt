...
extern int dxrt_driver_cdev_init(struct dxrt_driver *drv);
extern void dxrt_driver_cdev_deinit(struct dxrt_driver *drv);
extern int dxrt_request_handler(void *data);
extern void dxrt_init_queue(dxrt_queue_t* q, uint32_t max_count, uint32_t elem_size);
extern void dxrt_enable_queue(dxrt_queue_t *q);
extern void dxrt_disable_queue(dxrt_queue_t *q);
extern int dxrt_is_queue_empty(dxrt_queue_t* q);
extern int dxrt_is_queue_full(dxrt_queue_t* q);
extern void dxrt_lock_queue(dxrt_queue_t *q);
extern void dxrt_unlock_queue(dxrt_queue_t *q);
extern int dxrt_enqueue(dxrt_queue_t* q, void *elem);
extern int dxrt_dequeue(dxrt_queue_t* q, void *elem);
extern int dxrt_is_request_list_empty(dxrt_request_list_t *requests, spinlock_t *lock);
extern int message_handler_general(struct dxdev *dx, dxrt_message_t *msg);
