...
extern int en677_npu_dma_copy(uint32_t *data);
...
extern struct dxnpu *dxrt_npu_init(void *);
extern void dxrt_npu_deinit(void *dxdev_);
extern int dx_l1_npu_init(dxnpu_t *npu);
extern int dx_l1_npu_prepare_inference(dxnpu_t *npu);
extern int dx_l1_npu_run(dxnpu_t *npu, void*);
extern int dx_l1_npu_reg_dump(dxnpu_t *npu);
extern int dx_l1_npu_deinit(dxnpu_t *npu);
extern int dx_l3_npu_init(dxnpu_t *npu);
extern int dx_l3_npu_prepare_inference(dxnpu_t *npu);
extern int dx_l3_npu_run(dxnpu_t *npu, void*);
extern int dx_l3_npu_reg_dump(dxnpu_t *npu);
extern int dx_l3_npu_deinit(dxnpu_t *npu);
