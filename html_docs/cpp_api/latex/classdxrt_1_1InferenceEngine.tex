...
float \mbox{\hyperlink{classdxrt_1_1InferenceEngine_ab91c2e1adde9259fe2823416f80edb54}{Run\+Bench\+Mark}} (int num)
...
\begin{DoxyCompactList}\small\item\em Get recent inference time. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\DoxyCodeLine{\textcolor{keyword}{auto} modelPath = \textcolor{stringliteral}{"model.dxnn"}; \textcolor{comment}{// assume compiled model path name is "model.dxnn"}}
\DoxyCodeLine{\mbox{\hyperlink{structdxrt_1_1InferenceOption}{dxrt::InferenceOption}} option(1, 1, 2, dxrt::InferenceMode::MODE\_ASYNC);}
...
\end{DoxyReturn}
\mbox{\Hypertarget{classdxrt_1_1InferenceEngine_ab91c2e1adde9259fe2823416f80edb54}\label{classdxrt_1_1InferenceEngine_ab91c2e1adde9259fe2823416f80edb54}} 
...
{\footnotesize\ttfamily float dxrt\+::\+Inference\+Engine\+::\+Run\+Bench\+Mark (\begin{DoxyParamCaption}\item[{int}]{num }\end{DoxyParamCaption})}
