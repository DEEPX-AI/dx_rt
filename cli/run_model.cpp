...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        std::cout << "Device Driver Version: " << dxrt::Configuration::GetInstance().GetDriverVersion() << std::endl; 

        // print pcie driver version
        std::cout << "PCIe Driver Version: " << dxrt::Configuration::GetInstance().GetPCIeDriverVersion() << std::endl; 
