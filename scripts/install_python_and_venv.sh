...
usage() {
    ...
    echo -e "  ${COLOR_YELLOW}$0 --venv_path=/opt/existing_venv --venv-reuse # Reuse existing venv"
    echo -e "  ${COLOR_YELLOW}$0 --venv_path=/opt/old_venv --venv-force-remove # Force remove and recreate venv"
    echo -e ""
    exit 0
}
